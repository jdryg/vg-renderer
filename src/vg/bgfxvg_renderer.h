...
public:
	...
	virtual void StrokePath(vg::GradientHandle gradient, float width, bool aa, LineCap::Enum lineCap, LineJoin::Enum lineJoin);
	virtual void BeginClip(ClipRule::Enum rule);
