#ifndef VG_NANOVG_RENDERER_H
#define VG_NANOVG_RENDERER_H
...
public:
	...
	bool init(bool edgeAA, uint8_t viewID, bx::AllocatorI* allocator);
	...
	virtual GradientHandle BoxGradient(float x, float y, float w, float h, float r, float f, Color icol, Color ocol);
