...
void clFillPath(CommandListRef& ref, LocalGradientHandle gradient, uint32_t flags);
void clFillPath(CommandListRef& ref, LocalImagePatternHandle img, Color color, uint32_t flags);
...
void clStrokePath(CommandListRef& ref, LocalGradientHandle gradient, float width, uint32_t flags);
void clStrokePath(CommandListRef& ref, LocalImagePatternHandle img, Color color, float width, uint32_t flags);
...
LocalGradientHandle clCreateLinearGradient(CommandListRef& ref, float sx, float sy, float ex, float ey, Color icol, Color ocol);
LocalGradientHandle clCreateBoxGradient(CommandListRef& ref, float x, float y, float w, float h, float r, float f, Color icol, Color ocol);
LocalGradientHandle clCreateRadialGradient(CommandListRef& ref, float cx, float cy, float inr, float outr, Color icol, Color ocol);
LocalImagePatternHandle clCreateImagePattern(CommandListRef& ref, float cx, float cy, float w, float h, float angle, ImageHandle image);
